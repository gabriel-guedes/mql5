...
//| Inputs                                                           |
//+------------------------------------------------------------------+
input string   inpExpertName = "03_books_can_be_great";   //Expert Name
input int      inpShortMAPeriod = 5;                      //Short MA Period
input int      inpLongMAPeriod = 10;                      //Long  MA Period
...
void OnTick()
{
   ...
   if(shortMA[2] > longMA[2] && shortMA[1] < longMA[1]) {
      if(bar1.close < shortMA[1]) {
         goLong = true;
      }

   } else if(shortMA[2] < longMA[2] && shortMA[1] > longMA[1]) {
      if(bar1.close > shortMA[1]) {
         goShort = true;
      }
   }
