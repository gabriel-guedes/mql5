...
//| Inputs                                                           |
//+------------------------------------------------------------------+
input string   inpExpertName = "902_ma_slope";            //Expert Name
input uint     inpLookback = 10;                          //Lookback period
input uint     inpMAPeriod = 9;                           //MA Period
input bool     inpUseSLTP = false;                        //Use some kind of SLTP
...
void OnTick()
{
   ...
   if(utils.SlopeTurnUp(ma)) {
      goLong = true;

   } else if(utils.SlopeTurnDown(ma)) {
      goShort = true;
   }
